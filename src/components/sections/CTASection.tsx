  ...
  return (
    <section className="py-32 bg-[var(--color-primary)] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <svg
          className="absolute right-0 top-1/2 -translate-y-1/2 w-1/2 h-full opacity-[0.05]"
          viewBox="0 0 500 500"
          fill="none"
        >
          <circle cx="400" cy="250" r="300" stroke="white" strokeWidth="1" />
          <circle cx="400" cy="250" r="200" stroke="var(--color-accent)" strokeWidth="1" />
          <circle cx="400" cy="250" r="100" stroke="white" strokeWidth="1" />
        </svg>
      </div>

      {/* Left accent line */}
      <div className="absolute left-0 top-0 w-1.5 h-full bg-[var(--color-accent)]/40" />
        ...
        >
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#FEE500] text-[var(--color-text)] font-semibold tracking-wide hover:bg-[#F0D700] transition-colors duration-200 rounded-sm"
            >
            ...
            <a
              href={`tel:${phone}`}
              className="inline-flex items-center justify-center gap-3 px-8 py-4 border border-white/30 text-white font-semibold tracking-wide hover:border-white hover:bg-white/10 transition-all duration-200 rounded-sm"
            >
